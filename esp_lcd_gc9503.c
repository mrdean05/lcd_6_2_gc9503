...
static const gc9503_lcd_init_cmd_t vendor_specific_init_default[] = {
    ...
    {0xA7, (uint8_t []){0x47}, 1, 0},
    {0xA0, (uint8_t []){0xDD}, 1, 0},
    {0x86, (uint8_t []){0x99, 0xA3, 0xA3, 0x01}, 4, 0},
    {0xFA, (uint8_t []){0x08, 0x08, 0x00, 0x04}, 4, 0},
    {0xA3, (uint8_t []){0x6E}, 1, 0},
    {0xFD, (uint8_t []){0x28, 0x3C, 0x00}, 3, 0},
    {0x9A, (uint8_t []){0x98}, 1, 0},
    {0x9B, (uint8_t []){0x70}, 1, 0},
    {0x82, (uint8_t []){0x4E, 0x4E}, 2, 0},
    {0xB1, (uint8_t []){0x33}, 1, 0},
    {0x3A, (uint8_t []){0x60}, 1, 0},
    {0xB0, (uint8_t []){0x00, 0x19, 0x06, 0x14, 0x14}, 5, 0},
    {0x7A, (uint8_t []){0x13, 0x1A}, 2, 0},
    {0x7B, (uint8_t []){0x13, 0x1A}, 2, 0},
    {0x6D, (uint8_t []){0x1E, 0x1E, 0x1E, 0x03, 0x01, 0x09, 0x0F, 0x0B, 0x0D, 0x05, 0x07, 
                        0x1E, 0x1E, 0x1E, 0x1E, 0x1E, 0x1E, 0x1E, 0x1E, 0x1E, 0x1E, 0x08, 
                        0x06, 0x0E, 0x0C, 0x10, 0x0A, 0x02, 0x04, 0x1E, 0x1E, 0x1E}, 32, 0},
    {0x64, (uint8_t []){0x28, 0x05, 0x03, 0x23, 0x03, 0x03, 0x28, 0x04, 0x03, 0x24, 
                        0x03, 0x03, 0x2D, 0x6D, 0x2D, 0x6D}, 16, 0},
    {0x65, (uint8_t []){0x28, 0x01, 0x03, 0x27, 0x03, 0x03, 0x20, 0x00, 0x03, 0x28, 
                        0x03, 0x03, 0x2D, 0x6D, 0x2D, 0x6D}, 16, 0},
    {0x66, (uint8_t []){0x20, 0x01, 0x03, 0x29, 0x03, 0x03, 0x20, 0x02, 0x03, 0x2A, 
                        0x03, 0x03, 0x2D, 0x6D, 0x2D, 0x6D}, 16, 0},
    {0x67, (uint8_t []){0x28, 0x03, 0x03, 0x25, 0x03, 0x03, 0x28, 0x02, 0x03, 0x26, 
                        0x03, 0x03, 0x2D, 0x6D, 0x2D, 0x6D}, 16, 0},
    {0x60, (uint8_t []){0x38, 0x09, 0x6D, 0x6D, 0x38, 0x08, 0x6D, 0x6D}, 8, 0},
    {0x61, (uint8_t []){0x38, 0x07, 0x6D, 0x6D, 0x38, 0x06, 0x6D, 0x6D}, 8, 0},
    {0x62, (uint8_t []){0x33, 0x1B, 0x6D, 0x6D, 0x33, 0x1C, 0x6D, 0x6D}, 8, 0},
    {0x63, (uint8_t []){0x33, 0x1D, 0x6D, 0x6D, 0x33, 0x1E, 0x6D, 0x6D}, 8, 0},
    {0x69, (uint8_t []){0x14, 0x22, 0x14, 0x22, 0x44, 0x22, 0x08}, 7, 0},
    {0x6B, (uint8_t []){0x07}, 1, 0},
    {0xD1, (uint8_t []){
        0x00, 0x00, 0x00, 0x05, 0x00, 0x13, 0x00, 0x21, 0x00, 0x2F, 
        0x00, 0x48, 0x00, 0x5F, 0x00, 0x87, 0x00, 0xAB, 0x00, 0xE9, 
        0x01, 0x1F, 0x01, 0x7D, 0x01, 0xCF, 0x01, 0xD3, 0x02, 0x23, 
        0x02, 0x7A, 0x02, 0xB0, 0x02, 0xF6, 0x03, 0x25, 0x03, 0xC0, 
        0x03, 0xC5, 0x03, 0xCA, 0x03, 0xCC, 0x03, 0xD0, 0x03, 0xE1, 
        0x03, 0xFF
    }, 52, 0},
    // D2 through D6 have identical data to D1
    {0xD2, (uint8_t []){0x00, 0x00, 0x00, 0x04, 0x00, 0x12, 0x00, 0x18, 0x00, 0x21, 0x00, 0x2a, 0x00, 0x35, 0x00, 0x47, 0x00,
            0x56, 0x00, 0x90, 0x00, 0xe5, 0x01, 0x68, 0x01, 0xd5, 0x01, 0xd7, 0x02, 0x36, 0x02, 0xa6, 0x02, 0xee,
            0x03, 0x48, 0x03, 0xa0, 0x03, 0xba, 0x03, 0xc5, 0x03, 0xd0, 0x03, 0xe0, 0x03, 0xea, 0x03, 0xfa, 0x03,
            0xff}, 52, 0},
...
static const gc9503_lcd_init_cmd_t vendor_specific_init_default[] = {
    ...
    {0xAC, (uint8_t []){0x45}, 1, 0},
    {0xA7, (uint8_t []){0x47}, 1, 0},
    {0xA0, (uint8_t []){0xCC}, 1, 0},
    {0x86, (uint8_t []){0x99, 0xA3, 0xA3, 0x31}, 4, 0},
    {0xFA, (uint8_t []){0x08, 0x08, 0x00, 0x04}, 4, 0},
    {0xA3, (uint8_t []){0x6E}, 1, 0},
    {0xFD, (uint8_t []){0x28, 0x3C, 0x00}, 3, 0},
    ...
    {0x80, (uint8_t []){0x54}, 1, 0},
    {0xB0, (uint8_t []){0x00, 0x25, 0x20, 0x15, 0x10}, 5, 0},
    {0xB1, (uint8_t []){0x42}, 1, 0},
    {0x3A, (uint8_t []){0x50}, 1, 0},        //origibal {0x3A, (uint8_t []){0x60}, 1, 0},
    {0x7A, (uint8_t []){0x0F, 0x13}, 2, 0},
    {0x7B, (uint8_t []){0x0F, 0x13}, 2, 0},
    {0x6D, (uint8_t []){0x0C, 0x03, 0x1E, 0x02, 0x08, 0x1A, 0x19, 0x03, 0x0D, 0x0E, 0x0F, 
                        0x10, 0x1E, 0x1E, 0x1E, 0x1E, 0x1E, 0x1E, 0x1E, 0x1E, 0x11, 0x12, 
                        0x13, 0x14, 0x03, 0x19, 0x1A, 0x07, 0x01, 0x1E, 0x03, 0x0C}, 32, 0},
    {0x64, (uint8_t []){0x38, 0x04, 0x03, 0xC4, 0x03, 0x03, 0x38, 0x02, 0x03, 0xC6, 
                        0x03, 0x03, 0x2C, 0x7A, 0x2C, 0x7A}, 16, 0},
    {0x65, (uint8_t []){0x38, 0x08, 0x03, 0xC0, 0x03, 0x03, 0x38, 0x06, 0x03, 0xC2, 
                        0x03, 0x03, 0x2C, 0x7A, 0x2C, 0x7A}, 16, 0},
    {0x66, (uint8_t []){0x83, 0xD0, 0x03, 0xC4, 0x03, 0x03, 0x83, 0xD0, 0x03, 0xC4, 
                        0x03, 0x03, 0x2C, 0x7A, 0x2C, 0x7A}, 16, 0},
    {0x60, (uint8_t []){0x38, 0x0C, 0x3C, 0x3C, 0x38, 0x0B, 0x3C, 0x3C}, 8, 0},
    {0x61, (uint8_t []){0xB3, 0xC4, 0x3C, 0x3C, 0xB3, 0xC4, 0x3C, 0x3C}, 8, 0},
    {0x62, (uint8_t []){0xB3, 0xC4, 0x3C, 0x3C, 0xB3, 0xC4, 0x3C, 0x3C}, 8, 0},
    {0x63, (uint8_t []){0x38, 0x0A, 0x3C, 0x3C, 0x38, 0x09, 0x3C, 0x3C}, 8, 0},
    {0x68, (uint8_t []){0x77, 0x08, 0x0A, 0x08, 0x09, 0x00, 0x00, 0x18, 0x0A, 0x08, 
                        0x09, 0x00, 0x00}, 13, 0},
    {0x69, (uint8_t []){0x14, 0x22, 0x14, 0x22, 0x44, 0x22, 0x08}, 7, 0},
    {0x6B, (uint8_t []){0x07}, 1, 0},
    {0xD1, (uint8_t []){0x00, 0x00, 0x00, 0x10, 0x00, 0x22, 0x00, 0x2C, 0x00, 0x2E, 
                        0x00, 0x56, 0x00, 0x58, 0x00, 0x7C, 0x00, 0x9A, 0x00, 0xCE, 
                        0x00, 0xFA, 0x01, 0x4C, 0x01, 0x94, 0x01, 0x96, 0x01, 0xDA, 
                        0x02, 0x32, 0x02, 0x76, 0x02, 0xCC, 0x03, 0x18, 0x03, 0x55, 
                        0x03, 0x6B, 0x03, 0x9B, 0x03, 0xAC, 0x03, 0xB8, 0x03, 0xE0, 
                        0x03, 0xFF}, 52, 0},
    {0xD2, (uint8_t []){0x00, 0x00, 0x00, 0x10, 0x00, 0x22, 0x00, 0x2C, 0x00, 0x2E, 
                        0x00, 0x56, 0x00, 0x58, 0x00, 0x7C, 0x00, 0x9A, 0x00, 0xCE, 
                        0x00, 0xFA, 0x01, 0x4C, 0x01, 0x94, 0x01, 0x96, 0x01, 0xDA, 
                        0x02, 0x32, 0x02, 0x76, 0x02, 0xCC, 0x03, 0x18, 0x03, 0x55, 
                        0x03, 0x6B, 0x03, 0x9B, 0x03, 0xAC, 0x03, 0xB8, 0x03, 0xE0, 
                        0x03, 0xFF}, 52, 0},
    {0xD3, (uint8_t []){0x00, 0x00, 0x00, 0x10, 0x00, 0x22, 0x00, 0x2C, 0x00, 0x2E, 
                        0x00, 0x56, 0x00, 0x58, 0x00, 0x7C, 0x00, 0x9A, 0x00, 0xCE, 
                        0x00, 0xFA, 0x01, 0x4C, 0x01, 0x94, 0x01, 0x96, 0x01, 0xDA, 
                        0x02, 0x32, 0x02, 0x76, 0x02, 0xCC, 0x03, 0x18, 0x03, 0x55, 
                        0x03, 0x6B, 0x03, 0x9B, 0x03, 0xAC, 0x03, 0xB8, 0x03, 0xE0, 
                        0x03, 0xFF}, 52, 0},
    {0xD4, (uint8_t []){0x00, 0x00, 0x00, 0x10, 0x00, 0x22, 0x00, 0x2C, 0x00, 0x2E, 
                        0x00, 0x56, 0x00, 0x58, 0x00, 0x7C, 0x00, 0x9A, 0x00, 0xCE, 
                        0x00, 0xFA, 0x01, 0x4C, 0x01, 0x94, 0x01, 0x96, 0x01, 0xDA, 
                        0x02, 0x32, 0x02, 0x76, 0x02, 0xCC, 0x03, 0x18, 0x03, 0x55, 
                        0x03, 0x6B, 0x03, 0x9B, 0x03, 0xAC, 0x03, 0xB8, 0x03, 0xE0, 
                        0x03, 0xFF}, 52, 0},
    {0xD5, (uint8_t []){0x00, 0x00, 0x00, 0x10, 0x00, 0x22, 0x00, 0x2C, 0x00, 0x2E, 
                        0x00, 0x56, 0x00, 0x58, 0x00, 0x7C, 0x00, 0x9A, 0x00, 0xCE, 
                        0x00, 0xFA, 0x01, 0x4C, 0x01, 0x94, 0x01, 0x96, 0x01, 0xDA, 
                        0x02, 0x32, 0x02, 0x76, 0x02, 0xCC, 0x03, 0x18, 0x03, 0x55, 
                        0x03, 0x6B, 0x03, 0x9B, 0x03, 0xAC, 0x03, 0xB8, 0x03, 0xE0, 
                        0x03, 0xFF}, 52, 0},
    {0xD6, (uint8_t []){0x00, 0x00, 0x00, 0x10, 0x00, 0x22, 0x00, 0x2C, 0x00, 0x2E, 
                        0x00, 0x56, 0x00, 0x58, 0x00, 0x7C, 0x00, 0x9A, 0x00, 0xCE, 
                        0x00, 0xFA, 0x01, 0x4C, 0x01, 0x94, 0x01, 0x96, 0x01, 0xDA, 
                        0x02, 0x32, 0x02, 0x76, 0x02, 0xCC, 0x03, 0x18, 0x03, 0x55, 
                        0x03, 0x6B, 0x03, 0x9B, 0x03, 0xAC, 0x03, 0xB8, 0x03, 0xE0, 
